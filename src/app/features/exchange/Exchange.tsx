...
export const Exchange: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (transferTokenError) {
      toast.error(`Error en la transferencia: ${transferTokenError.message}`);
    }
    if (transferNFTError) {
      toast.error(`Error en la transferencia NFT: ${transferNFTError.message}`);
    }
